...
const CostHistoryFloor = ({ history, setHistory }) => {
  const { addLantaiEstimate, removeLantaiEstimate } = useBudget();
        ...
        <div style="overflow-x:auto;">
          <table style="width:100%;border-collapse:collapse;">
            <tbody>
              ...
              <tr>
                <td style="border:1px solid #ddd;padding:8px;"><b>Jenis Lantai:</b></td>
  ...
  return (
    <div className="p-4 bg-white rounded-lg shadow-md">
      <h2 className="mb-6 text-xl font-bold">History of Flooring Estimates</h2>
      <ul>
